...
<!-- Bootstrap -->
  ...
  <script src='https://kit.fontawesome.com/a076d05399.js'></script>
    ...
    <script type="text/javascript" src="{{ asset('../resources/js/search3.js') }}" async defer></script>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light myNav">
      ...
      <a class="navbar-brand logoNava" href="{{ route('home') }}"><img class="logoNav" src="{{ asset('/img/letra.png') }}" alt="imgLogo"></a>
      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        ...
        <ul class="navbar-nav ml-auto">
          ...
          @else
          <li class="nav-item myLi">
              <a class="nav-link myA" ><span class="mySpan">¡Welcome, {{ Auth::user() }}!</span></a>
          </li>
          @endguest
          ...
          @guest
            ...
            <li class="nav-item myLi dropdown">
              <a class="nav-link myA dropdown-toggle nav-links" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="{{ route('admin') }}"><span class="mySpan">Admin</span></a>
           
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                <a class="dropdown-item" href="{{ route('dog.addView') }}">New Dog</a>
                <a class="dropdown-item" href="{{ route('admin') }}">Requests</a>
