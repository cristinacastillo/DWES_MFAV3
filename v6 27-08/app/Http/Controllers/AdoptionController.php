                ...
                foreach ($data as $item):
                    ...
                    $output.='<tr class="myTr">
                                ...
                                <td class="myTd" data-label="Period">
                                  <a href="status?idAdop='. $item->idAdop .'&value=1&idDog='. $item->idDog .'" ><span class="badge badge-pill badge-success">Accept</span></a>
                                  <a href="status?idAdop='. $item->idAdop .'&value=2&idDog='. $item->idDog .'"><span class="badge badge-pill badge-danger">Denny</span></a>
                                </td>
                              </tr>';
