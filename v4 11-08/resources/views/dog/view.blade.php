			...
			<div class="col-sm-12">
				...
				@if(!$comment->isEmpty())
					...
					@foreach($comment as $item)
						...
						<!--dropdown-->
						<div class="dropdown">
							<button class="badge badgeCom dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">a</button>

							<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
								<span onclick="showForm('{{$item->idCom}}','editableCom{{$item->idCom}}')" class="dropdown-item">Edit comment</span>
								<a class="dropdown-item" >Delete comment</a
								<a class="dropdown-item" href="#">Something else here</a>
							</div>
						</div>

						<!--<a class="deleteButton">Modal</a>-->
		    ...
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
				...
				<form method="post" action="{{ route('dog.delete') }}">
					@csrf
					<input type="hidden" name="idDog" value="{{ $dog->idDog }}">
					<input type="hidden" name="idCom" value="auth()->user()->idUse">
