...
Route::middleware(['auth'])->group(function(){
	...
	Route::prefix('dog')->group(function () {
	    ...
	    Route::get('/req', 'DogController@requestAdop')->name('dog.req');
	    ...
	    Route::get('/search3', 'DogController@search');
	...
	Route::get('addDog','AdminController@addDogView' )->middleware('checkUserProfile')->name('dog.addView') ;
	
	//Search users
 	Route::get('/search', 'UserController@search');

 	Route::get('/search2', 'AdoptionController@search');
