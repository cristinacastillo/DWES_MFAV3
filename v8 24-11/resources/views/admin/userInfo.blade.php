        ...
        <div class="row">
            <div class="col ">
                ...
                @if ($user)
                    ...
                    <button id="myBtn" type="button" class="btn btn-danger btnA btnUnsuscribeUser">Unsubscribe</button>

                    <div class="card  mt-4 cardUserReq">


                        <img src="{{ asset('/storage/users') }}/{{ $user->photo }}"
                            class="card-img-top mx-auto mt-4 imgUser" alt="{{ $user->name }} {{ $user->surnames }}">
                    ...
                    @foreach ($adops as $adop)
                        @if ($adop->status == 1)
                            <div class="media mediaUser p-4">
                                <img src="{{ asset('/storage/dogs') }}/{{ $adop->photo }}" class="mr-3 photoDogUser"
                                    alt="...">
                                <div class="media-body">
                                    <h5 class="mt-0"><b><a
                                                href="{{ route('dog.info', ['id' => $adop->idDog]) }}">{{ $adop->name }}</a></b>
                                    </h5>
                    ...
                    @foreach ($reqs as $adop)
                        ...
                        <div class="media mediaUser p-4">
                            ...
                            <div class="media-body">
                                ...
                                <a href="{{ route('adop.status', ['idAdop' => $adop->idAdop, 'value' => 1, 'idDog' => $adop->idDog]) }}" "><span class="
                                    badge badge-pill badge-success">Accept</span></a>
                                <a href="{{ route('adop.status', ['idAdop' => $adop->idAdop, 'value' => 2, 'idDog' => $adop->idDog]) }}" "><span class="
