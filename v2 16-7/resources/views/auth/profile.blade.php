				    ...
				    <div class="modal-content">
				      ...
				      <div class="modal-body">
				        ...
				        <form id="formEdit" role="form">
				        	...
				        	<input type="submit" name="action_button" id="action_button" value="aadd">
				      ...
				      <div class="modal-footer">
				        ...
				        <button type="submit" class="btn btn-primary submitBtn" onclick="editProfile()">Save changes</button>
				      </div>
				    </div>
				  </div>
				</div>
