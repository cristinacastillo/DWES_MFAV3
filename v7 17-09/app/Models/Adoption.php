...
class Adoption extends Model
{
    ...
    public static function showAdoptionsUser(int $idUse){
        ...
        $adops = Adoption::from('adoption as a')
                         ...
                         ->select("d.idDog","d.name","d.photo","d.breed","a.dateAdop","a.status","a.idAdop","a.idUse")
                         ->where('a.idUse','=', $idUse)
                         ->where('a.status','=', 1)
                         ->get();
    ...
    public static function showRequestUser(int $idUse){
    ...
    public static function showForAdminSearch(string $name){
        ...
        $adop = DB::table('dog as d')
                        ...
                        ->join('user as u',function($join){
                         ...
                         ->select("a.*","d.name as nameDog","u.name as nameUse")
                         ->where([['a.status','=', 0] , ['u.name','LIKE','%'.$name."%"]])
                         ->OrWhere([['a.status','=', 0] , ['d.name','LIKE','%'.$name."%"]])
                         ->OrWhere([['a.status','=', 0] , ['a.dateAdop','LIKE','%'.$name."%"]])
                         ->OrWhere([['a.status','=', 0] , ['a.reason','LIKE','%'.$name."%"]])
                         ->orderBy('a.dateAdop','asc')
                         ->get();
