	...
	<div class="cotntainer">
		...
		<div class="row">
			<div class="col-sm-6 ">
				...
				@if($dog->status == 1)
					<p>The dog is already adopted by </p>{{ $nameUser ?? '' }}
				@else
					@if($comp)
					...
					<button type="button" class="buttonReq" data-toggle="modal" data-target="#exampleModalLong">
					  Request Adoption
					</button>
...
<!---------- COMENTARIOS ---------->
		...
		<div class="row">
			...
			<div class="col-sm-12">
								...
								@if(auth()->user()->idUse == $item->idUse)
									...
									<div id="editableCom{{$item->idCom}}">
										...
										<form action="{{ route('edit.comment') }}" method="post">
											...
											<textarea name="comment"  class="md-textarea form-control commentText" rows="4" required>{{ $item->comment }}</textarea>
				...
				<br>
				<h6 class="text-center">No comments about {{ $dog->name }} yet.</h6>
			      ...
			      <div class="modal-body">
			        ...
			        <form method="post" action="{{ route('add.comment') }}">
					    ...
					    <div class="field mt-4">
				            ...
				            <textarea class="myInput rounded-0" id="exampleFormControlTextarea2" rows="3" name="comment" required></textarea>
	...
	<!-------------------------------->
		...
		<div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
		  	<div class="modal-dialog" role="document">
		    	<div class="modal-content">
			      	<div class="modal-header">
			      		<h4 class="mt-4">REQUEST ADOPTION</h4>
						...
						<form method="post" action="{{ route('dog.req') }}">
							...
							<div class="row form-group">
						        <div class="col-md-12 mx-auto">
									<ul class="">
										<li>State in a maximum of 500 the reason why you would like to adopt Truffle.</li>
										<li>The administrator will read the request.</li>
										<li>If it is favorable, the administrator will contact you. Otherwise, you can reapply for adoption.</li>
						    ...
						    <div class="field">
					            ...
					            <textarea class="myInput rounded-0" id="exampleFormControlTextarea2" rows="3" name="reason" required></textarea>
					            <label class="myLabel" for="reason">Reason:</label>
							...
							<div class="row form-group">
						        <div class="col-md-6 mx-auto">
						        	...
						        	<button class="myButton" type="submit">Send request</button>
